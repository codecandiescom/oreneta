...
public class FlowTableModel extends OrenetaTableModel {
	Meter meter;
	int meter_id;
	...
	////////////////////////////////////////////////////////////////////////////
	public FlowTableModel (Meter meter) {
		this.meter = meter;
  		...
  		if (f != null) {
  			switch (col) {
  				case 10:
					...
					if (f.monitor)
						meter.analyzer.drawFlow(f);
					else
						meter.analyzer.undrawFlow(f);
