...
public class TableSorter extends TableMap {
    ...
    public void tableChanged () {
    	reallocateIndexes();
    	sortByColumn(t_column, t_ascending);
    	// supose the whole table has changed (not very efficient :)
        ...
        MouseAdapter listMouseListener = new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                ...
                if (e.getClickCount() == 1 && column != -1) {
                    ...
                    if (t_column == column) {
                    	t_ascending = !t_ascending;
                    } else {
                    	t_column = column;
                    	t_ascending = true;
                    }
                    // boolean ascending = (shiftPressed == 0); 
                    sorter.sortByColumn(column, t_ascending); 
                }
            }
        };
