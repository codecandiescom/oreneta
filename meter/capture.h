...
/* IPv4 header */
typedef struct {
	unsigned char version_and_h_length;
	unsigned char tos;
	unsigned short int length;
	unsigned short int id;
	unsigned short int flags_and_offset;
	unsigned char ttl;
	unsigned char proto;
...
/* IPv6 header */
typedef struct {
	unsigned long version_tclass_flabel;
	unsigned short int length;
...
#define IPPROTO_HOP2HOP  0    /* IPv6 hop by hop option header       */
...
#define IPPROTO_ESP      50   /* IPv6 encapsulating security payload */
#define IPPROTO_AH       51   /* IPv6 authentication header          */
#define IPPROTO_ICMP6    58   /* IPv6 ICMPv6                         */
...
/* Modified by Abel Navarro, 2003 */

/* http://wifiscanner.sourceforge.net/dox/crc-32_8c-source.html */
